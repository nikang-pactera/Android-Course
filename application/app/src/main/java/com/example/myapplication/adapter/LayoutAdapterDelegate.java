...
public class LayoutAdapterDelegate extends ClickableAdapterDelegate<String, LayoutAdapterDelegate.ViewHolder> {
    private LayoutActivity mActivity;

    public LayoutAdapterDelegate(LayoutActivity activity) {
